...
urlpatterns = [
    ...
    path('waitlist/leave/', leave_waitlist, name='leave_waitlist'),
    path('waitlist/quote/', waitlist_checkout_quote, name='waitlist_checkout_quote'),
    path('waitlist/buy/', buy_waitlist_ticket, name='buy_waitlist_ticket'),
    path('waitlist/pay/<uuid:token>/', waitlist_pay_page, name='waitlist_pay'),
